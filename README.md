...
> Not to make AI easier to use, but to turn human-AI collaboration into structure, process, and assets.
...
The first version of CoStruct focuses on a small but complete loop:

1. State recognition
2. Human-AI collaboration mode selection
3. Task execution
